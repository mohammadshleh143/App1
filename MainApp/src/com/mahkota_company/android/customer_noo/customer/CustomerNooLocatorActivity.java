...
public class CustomerNooLocatorActivity extends Activity implements	LocationListener {
	...
	private static final String LOG_TAG = CustomerNooLocatorActivity.class.getSimpleName();
	...
	public void gotoDetailCustomer() {
		...
		if (main_app_table_id != null) {
			saveAppDataCustomerIdCustomer(main_app_table_id);
			Intent i = new Intent(CustomerNooLocatorActivity.this,
