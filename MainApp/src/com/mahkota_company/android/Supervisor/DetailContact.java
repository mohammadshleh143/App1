...
public class DetailContact extends FragmentActivity {
    private Context act;
    ...
    private static final String LOG_TAG = com.mahkota_company.android.supervisor.DetailContact.class
            .getSimpleName();
    ...
    public void gotoCustomerLocator() {
        ...
        if (main_app_table_id != null) {
            ...
            Intent intentActivity = new Intent(
                    com.mahkota_company.android.supervisor.DetailContact.this,
    ...
    */
    ...
    private void previewImageDialog() {
        if (customer != null) {
            ...
            imagesDialog.setContentView(com.mahkota_company.android.supervisor.DetailContact.this
