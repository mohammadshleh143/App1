...
public class DetailCustomerJadwalLocator extends Activity implements
		LocationListener {
	private Context act;
	...
	private static final String LOG_TAG = DetailCustomerJadwalLocator.class
			.getSimpleName();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String main_app_table_kode_customer = spPreferences.getString(
				CONFIG.SHARED_PREFERENCES_TABLE_CUSTOMER_KODE_CUSTOMER, null);
		if (main_app_table_kode_customer != null) {
			saveAppDataCustomerIdCustomer(main_app_table_kode_customer);

			Customer customer_from_db = databaseHandler.getCustomer1(main_app_table_kode_customer);
	...
	public void gotoDetailCustomer() {
		...
		if (main_app_table_kode_customer != null) {
			saveAppDataCustomerIdCustomer(main_app_table_kode_customer);
			Intent i = new Intent(DetailCustomerJadwalLocator.this,
