package com.mahkota_company.android.check_new_prospect;
...
public class CheckCustomerProspectActivity extends ActionBarActivity implements
	...
	private static final String LOG_TAG = CheckCustomerProspectActivity.class
			.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_customer_prospect_uploaded);
		...
		mNavigationDrawerFragment.selectItem(12);
			...
			public void onTextChanged(CharSequence cs, int arg1, int arg2,
				...
				if (cs.toString().length() > 0) {
					...
					ArrayList<Customer> customer_from_db = databaseHandler
							.getAllCustomerProspectUploadedBaseOnSearch(cs.toString());
					if (customer_from_db.size() > 0) {
						...
						cAdapter = new ListViewAdapter(
								CheckCustomerProspectActivity.this,
					...
					customer_list.clear();
					ArrayList<Customer> customer_from_db = databaseHandler
							.getAllCustomerProspectUploaded();
					if (customer_from_db.size() > 0) {
						listview.setVisibility(View.VISIBLE);
						for (int i = 0; i < customer_from_db.size(); i++) {
							int id_customer = customer_from_db.get(i)
			...
			row.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					String id_customer = String.valueOf(data.get(position)
							.getId_customer());
					gotoDetailCustomerProspect(id_customer);
	...
	public void gotoDetailCustomerProspect(final String id_customer) {
		saveAppDataCustomerIdCustomer(id_customer);
		Intent i = new Intent(this, DetailCheckCustomerProspectActivity.class);
		startActivity(i);
		finish();
	}
	...
	public void onNavigationDrawerItemSelected(int position) {
		if (mNavigationDrawerFragment != null) {
			if (mNavigationDrawerFragment.getCurrentSelectedPosition() != 12) {
				if (position == 0) {
